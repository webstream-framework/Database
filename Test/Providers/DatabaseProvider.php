...
trait DatabaseProvider
{
    public function selectProvider()
    {
        return [
            ...
            ['SELECT * FROM T_WebStream', [], [['id' => 1, 'name' => 'test1'], ['id' => 2, 'name' => 'test2']], 'WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml'],
            ['SELECT * FROM T_WebStream WHERE id = :id', ['id' => 1], [['id' => 1, 'name' => 'test1']], 'WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml']
        ];
    }
    ...
    public function insertProvider()
    {
        return [
            ...
            ['INSERT INTO T_WebStream (name) VALUES (:name)', ['name' => 'test3'], 1, 'WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml']
        ];
    }
    ...
    public function updateProvider()
    {
        return [
            ...
            ['UPDATE T_WebStream SET name = :name WHERE id = :id', ['id' => 1, 'name' => 'test4'], 1, 'WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml']
        ];
    }
    ...
    public function deleteProvider()
    {
        return [
            ...
            ['DELETE FROM T_WebStream', 'WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml']
        ];
    }
    ...
    public function transactionProvider()
    {
        return [
            ...
            ['WebStream\Database\Driver\Mysql', '/Fixtures/database.mariadb.yml']
        ];
    }
}
